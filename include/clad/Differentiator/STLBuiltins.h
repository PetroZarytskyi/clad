...
template <typename T>
void resize_pushforward(::std::vector<T>* v, typename ::std::vector<T>::size_type sz, ::std::vector<T>* d_v,
...
void resize_pushforward(::std::vector<T>* v, typename ::std::vector<T>::size_type sz, U val,
                        ::std::vector<T>* d_v, typename ::std::vector<T>::size_type d_sz, U d_val) {
  d_v->resize(sz, d_val);
  v->resize(sz, val);
}
...
operator_subscript_pushforward(::std::vector<T>* v, typename ::std::vector<T>::size_type idx,
...
operator_subscript_pushforward(const ::std::vector<T>* v, typename ::std::vector<T>::size_type idx,
                               const ::std::vector<T>* d_v, typename ::std::vector<T>::size_type d_idx) {
  return {(*v)[idx], (*d_v)[idx]};
}

template <typename T>
ValueAndPushforward<T&, T&> at_pushforward(::std::vector<T>* v, typename ::std::vector<T>::size_type idx,
                                           ::std::vector<T>* d_v,
...
template <typename T>
ValueAndPushforward<const T&, const T&>
at_pushforward(const ::std::vector<T>* v, typename ::std::vector<T>::size_type idx,
               const ::std::vector<T>* d_v, typename ::std::vector<T>::size_type d_idx) {
  return {(*v)[idx], (*d_v)[idx]};
}
