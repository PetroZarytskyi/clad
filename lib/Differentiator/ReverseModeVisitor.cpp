...
Expr* ReverseModeVisitor::getStdInitListSizeExpr(const Expr* E) {
  ...
  StmtDiff ReverseModeVisitor::VisitCXXTemporaryObjectExpr(const clang::CXXTemporaryObjectExpr* TOE) {
    return Clone(TOE);
  }

  StmtDiff ReverseModeVisitor::VisitCXXBindTemporaryExpr(const clang::CXXBindTemporaryExpr* BTE) {
