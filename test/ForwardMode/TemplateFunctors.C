...
template <typename T> struct ExperimentConst {
  mutable T x, y;
  ExperimentConst() : x(), y() {}
  ExperimentConst(T p_x, T p_y) : x(p_x), y(p_y) {}
...
// CHECK-NEXT:     double _d_i = 1;
// CHECK-NEXT:     double _d_j = 0;
// CHECK-NEXT:     const ExperimentConst<double> _d_this_obj;
// CHECK-NEXT:     const ExperimentConst<double> *_d_this = &_d_this_obj;
// CHECK-NEXT:     double _d_x = 0;
// CHECK-NEXT:     double _d_y = 0;
// CHECK-NEXT:     double &_t0 = this->x;
// CHECK-NEXT:     double _t1 = _t0 * i;
...
template <> struct ExperimentConst<long double> {
  mutable long double x, y;
  ExperimentConst() : x(), y() {}
  ExperimentConst(long double p_x, long double p_y) : x(p_x), y(p_y) {}
...
// CHECK: long double operator_call_darg0(long double i, long double j) const {
// CHECK-NEXT:     long double _d_i = 1;
// CHECK-NEXT:     long double _d_j = 0;
// CHECK-NEXT:     const ExperimentConst<long double> _d_this_obj;
// CHECK-NEXT:     const ExperimentConst<long double> *_d_this = &_d_this_obj;
// CHECK-NEXT:     long double _d_x = 0;
// CHECK-NEXT:     long double _d_y = 0;
// CHECK-NEXT:     long double &_t0 = this->x;
// CHECK-NEXT:     long double _t1 = _t0 * i;
...
int main() {
  ...
  ExperimentConst<double> EConst_double(3, 5);
  ExperimentConst<long double> EConst_ld(3, 5);
  ...
  TEST_DOUBLE(EConst_double, 7, 9);          // CHECK-EXEC: {42.00, 42.00}
  TEST_LONG_DOUBLE(EConst_ld, 7, 9);         // CHECK-EXEC: {378.00, 378.00}
  ...
  TEST_DOUBLE(EConst_double, 7, 9);          // CHECK-EXEC: {70.00, 70.00}
  TEST_LONG_DOUBLE(EConst_ld, 7, 9);         // CHECK-EXEC: {630.00, 630.00}
}
