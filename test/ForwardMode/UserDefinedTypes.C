...
// CHECK: inline constexpr clad::ValueAndPushforward<complex<double> &, complex<double> &> operator_equal_pushforward({{.*}}complex<double> &&param, {{.*}}complex<double> *_d_this, {{.*}}complex<double> &&_d_param) noexcept {
