...
// CHECK: void fn_mul_jac(double i, double j, double *res, clad::array_ref<clad::matrix<double> > _d_vector_res) {
...
// CHECK: void f_1_jac(double x, double y, double z, double output[], clad::array_ref<clad::matrix<double> > _d_vector_output) {
