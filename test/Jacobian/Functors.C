...
struct ExperimentConst {
  ...
  // CHECK: void operator_call_jac(double i, double j, double *output, clad::array_ref<clad::matrix<double> > _d_vector_output) const {
  // CHECK-NEXT:     unsigned long indepVarCount = * _d_vector_output.rows() + {{2U|2UL|2ULL}};
  // CHECK-NEXT:     clad::array<double> _d_vector_i = clad::one_hot_vector(indepVarCount, {{0U|0UL|0ULL}});
  // CHECK-NEXT:     clad::array<double> _d_vector_j = clad::one_hot_vector(indepVarCount, {{1U|1UL|1ULL}});
  // CHECK-NEXT:     * _d_vector_output = clad::identity_matrix(* _d_vector_output.rows(), indepVarCount, {{2U|2UL|2ULL}});
...
struct ExperimentVolatile {
  ...
  // CHECK: void operator_call_jac(double i, double j, double *output, clad::array_ref<clad::matrix<double> > _d_vector_output) volatile {
  // CHECK-NEXT:     unsigned long indepVarCount = * _d_vector_output.rows() + {{2U|2UL|2ULL}};
  // CHECK-NEXT:     clad::array<double> _d_vector_i = clad::one_hot_vector(indepVarCount, {{0U|0UL|0ULL}});
  // CHECK-NEXT:     clad::array<double> _d_vector_j = clad::one_hot_vector(indepVarCount, {{1U|1UL|1ULL}});
  // CHECK-NEXT:     * _d_vector_output = clad::identity_matrix(* _d_vector_output.rows(), indepVarCount, {{2U|2UL|2ULL}});
...
struct ExperimentConstVolatile {
  ...
  // CHECK: void operator_call_jac(double i, double j, double *output, clad::array_ref<clad::matrix<double> > _d_vector_output) const volatile {
  // CHECK-NEXT:     unsigned long indepVarCount = * _d_vector_output.rows() + {{2U|2UL|2ULL}};
  // CHECK-NEXT:     clad::array<double> _d_vector_i = clad::one_hot_vector(indepVarCount, {{0U|0UL|0ULL}});
  // CHECK-NEXT:     clad::array<double> _d_vector_j = clad::one_hot_vector(indepVarCount, {{1U|1UL|1ULL}});
  // CHECK-NEXT:     * _d_vector_output = clad::identity_matrix(* _d_vector_output.rows(), indepVarCount, {{2U|2UL|2ULL}});
...
namespace outer {
  ...
  // CHECK: inline void operator_call_jac(double i, double j, double *output, clad::array_ref<clad::matrix<double> > _d_vector_output) const {
  // CHECK-NEXT:     unsigned long indepVarCount = * _d_vector_output.rows() + {{2U|2UL|2ULL}};
  // CHECK-NEXT:     clad::array<double> _d_vector_i = clad::one_hot_vector(indepVarCount, {{0U|0UL|0ULL}});
  // CHECK-NEXT:     clad::array<double> _d_vector_j = clad::one_hot_vector(indepVarCount, {{1U|1UL|1ULL}});
  // CHECK-NEXT:     * _d_vector_output = clad::identity_matrix(* _d_vector_output.rows(), indepVarCount, {{2U|2UL|2ULL}});
...
int main() {
  ...
  // CHECK-NEXT: inline void operator_call_jac(double i, double j, double *output, clad::array_ref<clad::matrix<double> > _d_vector_output) const {
  // CHECK-NEXT:     unsigned long indepVarCount = * _d_vector_output.rows() + {{2U|2UL|2ULL}};
  // CHECK-NEXT:     clad::array<double> _d_vector_i = clad::one_hot_vector(indepVarCount, {{0U|0UL|0ULL}});
  // CHECK-NEXT:     clad::array<double> _d_vector_j = clad::one_hot_vector(indepVarCount, {{1U|1UL|1ULL}});
  // CHECK-NEXT:     * _d_vector_output = clad::identity_matrix(* _d_vector_output.rows(), indepVarCount, {{2U|2UL|2ULL}});
...
// CHECK: inline void operator_call_jac(double i, double jj, double *output, clad::array_ref<clad::matrix<double> > _d_vector_output) const {
// CHECK-NEXT:     unsigned long indepVarCount = * _d_vector_output.rows() + {{2U|2UL|2ULL}};
// CHECK-NEXT:     clad::array<double> _d_vector_i = clad::one_hot_vector(indepVarCount, {{0U|0UL|0ULL}});
