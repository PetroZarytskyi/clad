...
// CHECK: clad::ValueAndAdjoint<double *, double *> ptrValFn_reverse_forw(double *x, int n, double *_d_x, int _d_n, clad::smart_tape &tape) {
// CHECK-NEXT:     _d_x += n;
// CHECK-NEXT:     x += n;
...
// CHECK-NEXT:     clad::ValueAndAdjoint<double *, double *> _t0 = ptrValFn_reverse_forw(arr, 1, _d_arr, 0, _tape0);
